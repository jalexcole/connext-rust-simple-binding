...
const NDDSHOME_ENVVAR: &str = "NDDSHOME";
const CONNEXTDDS_ARCH_ENVVAR: &str = "CONNEXTDDS_ARCH";
const ARCHSTR_DEFAULT: &str = "x64Linux4gcc7.3.0";
const IDL: &str = "res/hello.idl";
...
fn main() {
    ...
    let nddshome =
        env::var(NDDSHOME_ENVVAR).unwrap_or_else(|_| panic!("{NDDSHOME_ENVVAR} envvar is not set"));
